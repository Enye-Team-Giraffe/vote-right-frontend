...
export const SUCCESSFULL_NIN = `Your One time password is being sent to your phone, 
                                Kindly wait a while`;
...
export const USER_ALREADY_LOGGED = 'Sucessfully logged in, Please proceed to the dashboard';
...
export const WRONG_NIN_OR_NUMBER = ['Enter Another', 'NIN/phone number?'];
